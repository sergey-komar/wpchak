<?php
class Chack_Menu_Categorys extends Walker_Nav_menu {
	/**
	...
	public function start_lvl( &$output, $depth = 0, $args = null ) {
		...
		// Default class. СТАВИМ СВОИ КЛАССЫ
		$classes = array( 'sub-menu' );
		if($depth > 0){
			$classes = array( 'sub-menu aside__sub' );
		}else{
			$classes = array( 'sub-menu aside__nav' );
		}
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
		...
		//ДОБАВИЛИ СВОЙ КЛАСС ВЛОЖЕННОЙ ССЫЛКЕ В МЕНЮ
		$atts['class'] = $menu_item->current ? 'link-page' : '';
