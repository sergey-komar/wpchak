    ...
    <main class="main">
            ...
            <div class="slider-home__wrapper">
              <div class="slider-home__item">
                ...
                <div class="slider-home__img">
                  <img src="./images/home/slider-home-img.png" alt="img">
                </div>
              </div>
            </div>
          ...
          <div class="category-block">
            <div class="category-block__item">
              <div class="category-block__item-img">
                <img src="./images/home/category-image.jpg" alt="img">
              </div>
              <div class="category-block__item-title">Электроприводы</div>
              <a href="#" class="category-block__item-btn btn">Смотреть товары</a>
            </div>
            <div class="category-block__item">
              <div class="category-block__item-img">
                <img src="./images/home/category-image.jpg" alt="img">
      ...
      <section class="goods">
        <div class="container">
          ...
          <div class="goods-block">
            <div class="goods-block__item">
              <div class="goods-block__item-img">
                <img src="./images/home/goods-home-img.jpg" alt="img">
              </div>
              <div class="goods-block__item-title">
                Фланец воротниковый стальной Ду 80 Ру 6 ст.20 ГОСТ 12821-80
              </div>
              <div class="goods-block__info">
                <div class="goods-block__info-price">ОТ 1920 ₽</div>
                <div class="goods-block__info-icon">
                  <a href="#">
                    <img src="./images/home/goods-heart.svg" alt="img">
                  </a>
                  <a href="#">
                    <img src="./images/home/goods-basket.svg" alt="img">
                  </a>
                </div>
              </div>

              <a href="./product.html" class="goods-block__item-btn btn">К товару</a>
            </div>
            <div class="goods-block__item">
              <div class="goods-block__item-img">
                <img src="./images/home/goods-home-img.jpg" alt="img">
              ...
              <a href="#" class="goods-block__item-btn btn">К товару</a>
            </div>
            <div class="goods-block__item">
              <div class="goods-block__item-img">
                <img src="./images/home/goods-home-img.jpg" alt="img">
          ...
          <a href="#" class="goods__link">Смотреть больше товаров</a>
        </div>
      </section>
            ...
            <div class="advantages-block__content">
              <div class="advantages-block__content-item">
                <div class="advantages-block__img">
                  <img src="./images/home/advantages-icon-1.png" alt="img">
                </div>
              ...
              <div class="advantages-block__content-item">
                <div class="advantages-block__img">
                  <img src="./images/home/advantages-icon-2.png" alt="img">
                </div>
                <div class="advantages-block__box">
              ...
              <div class="advantages-block__content-item">
                <div class="advantages-block__img">
                  <img src="./images/home/advantages-icon-3.png" alt="img">
                </div>
                <div class="advantages-block__box">
              ...
              <div class="advantages-block__content-item">
                <div class="advantages-block__img">
                  <img src="./images/home/advantages-icon-4.png" alt="img">
                </div>
                <div class="advantages-block__box">
          ...
          <div class="special-block">
            ...
            <form  class="special-block__form">
              ...
              <div class="special-block__form-input">
                <img src="./images/home/special-user.png" alt="img">
                <input type="text" placeholder="Имя">
              </div>

              <div class="special-block__form-input">
                <img src="./images/home/special-phone.png" alt="img">
